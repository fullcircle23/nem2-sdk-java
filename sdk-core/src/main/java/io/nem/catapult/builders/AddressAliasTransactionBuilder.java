...
public final class AddressAliasTransactionBuilder extends TransactionBuilder {
     ...
     */
    protected AddressAliasTransactionBuilder(final SignatureDto signature, final KeyDto signerPublicKey, final short version, final EntityTypeDto type, final AmountDto fee, final TimestampDto deadline, final AliasActionDto aliasAction, final NamespaceIdDto namespaceId, final AddressDto address) {
     ...
     */
    public static AddressAliasTransactionBuilder create(final SignatureDto signature, final KeyDto signerPublicKey, final short version, final EntityTypeDto type, final AmountDto fee, final TimestampDto deadline, final AliasActionDto aliasAction, final NamespaceIdDto namespaceId, final AddressDto address) {
        return new AddressAliasTransactionBuilder(signature, signerPublicKey, version, type, fee, deadline, aliasAction, namespaceId, address);
    }
