...
public final class EmbeddedAddressAliasTransactionBuilder extends EmbeddedTransactionBuilder {
     ...
     */
    protected EmbeddedAddressAliasTransactionBuilder(final KeyDto signerPublicKey, final short version, final EntityTypeDto type, final AliasActionDto aliasAction, final NamespaceIdDto namespaceId, final AddressDto address) {
     ...
     */
    public static EmbeddedAddressAliasTransactionBuilder create(final KeyDto signerPublicKey, final short version, final EntityTypeDto type, final AliasActionDto aliasAction, final NamespaceIdDto namespaceId, final AddressDto address) {
        return new EmbeddedAddressAliasTransactionBuilder(signerPublicKey, version, type, aliasAction, namespaceId, address);
    }
