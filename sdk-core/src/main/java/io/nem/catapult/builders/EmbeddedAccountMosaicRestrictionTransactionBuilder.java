...
public final class EmbeddedAccountMosaicRestrictionTransactionBuilder extends EmbeddedTransactionBuilder {
     ...
     */
    protected EmbeddedAccountMosaicRestrictionTransactionBuilder(final KeyDto signerPublicKey, final short version, final EntityTypeDto type, final AccountRestrictionTypeDto restrictionType, final ArrayList<AccountMosaicRestrictionModificationBuilder> modifications) {
     ...
     */
    public static EmbeddedAccountMosaicRestrictionTransactionBuilder create(final KeyDto signerPublicKey, final short version, final EntityTypeDto type, final AccountRestrictionTypeDto restrictionType, final ArrayList<AccountMosaicRestrictionModificationBuilder> modifications) {
        return new EmbeddedAccountMosaicRestrictionTransactionBuilder(signerPublicKey, version, type, restrictionType, modifications);
    }
