...
public final class EmbeddedMosaicDefinitionTransactionBuilder extends EmbeddedTransactionBuilder {
     ...
     */
    protected EmbeddedMosaicDefinitionTransactionBuilder(final KeyDto signerPublicKey, final short version, final EntityTypeDto type, final MosaicNonceDto nonce, final MosaicIdDto id, final EnumSet<MosaicFlagsDto> flags, final byte divisibility, final BlockDurationDto duration) {
     ...
     */
    public static EmbeddedMosaicDefinitionTransactionBuilder create(final KeyDto signerPublicKey, final short version, final EntityTypeDto type, final MosaicNonceDto nonce, final MosaicIdDto id, final EnumSet<MosaicFlagsDto> flags, final byte divisibility, final BlockDurationDto duration) {
        return new EmbeddedMosaicDefinitionTransactionBuilder(signerPublicKey, version, type, nonce, id, flags, divisibility, duration);
    }
