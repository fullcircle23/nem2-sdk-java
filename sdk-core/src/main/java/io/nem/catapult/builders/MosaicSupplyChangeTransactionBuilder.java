...
public final class MosaicSupplyChangeTransactionBuilder extends TransactionBuilder {
     ...
     */
    protected MosaicSupplyChangeTransactionBuilder(final SignatureDto signature, final KeyDto signerPublicKey, final short version, final EntityTypeDto type, final AmountDto fee, final TimestampDto deadline, final UnresolvedMosaicIdDto mosaicId, final MosaicSupplyChangeActionDto action, final AmountDto delta) {
     ...
     */
    public static MosaicSupplyChangeTransactionBuilder create(final SignatureDto signature, final KeyDto signerPublicKey, final short version, final EntityTypeDto type, final AmountDto fee, final TimestampDto deadline, final UnresolvedMosaicIdDto mosaicId, final MosaicSupplyChangeActionDto action, final AmountDto delta) {
        return new MosaicSupplyChangeTransactionBuilder(signature, signerPublicKey, version, type, fee, deadline, mosaicId, action, delta);
    }
