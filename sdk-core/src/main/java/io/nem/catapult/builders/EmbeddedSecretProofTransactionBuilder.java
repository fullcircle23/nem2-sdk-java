...
public final class EmbeddedSecretProofTransactionBuilder extends EmbeddedTransactionBuilder {
     ...
     */
    protected EmbeddedSecretProofTransactionBuilder(final KeyDto signerPublicKey, final short version, final EntityTypeDto type, final LockHashAlgorithmDto hashAlgorithm, final Hash256Dto secret, final UnresolvedAddressDto recipientAddress, final ByteBuffer proof) {
     ...
     */
    public static EmbeddedSecretProofTransactionBuilder create(final KeyDto signerPublicKey, final short version, final EntityTypeDto type, final LockHashAlgorithmDto hashAlgorithm, final Hash256Dto secret, final UnresolvedAddressDto recipientAddress, final ByteBuffer proof) {
        return new EmbeddedSecretProofTransactionBuilder(signerPublicKey, version, type, hashAlgorithm, secret, recipientAddress, proof);
    }
