...
public final class EmbeddedMosaicSupplyChangeTransactionBuilder extends EmbeddedTransactionBuilder {
     ...
     */
    protected EmbeddedMosaicSupplyChangeTransactionBuilder(final KeyDto signerPublicKey, final short version, final EntityTypeDto type, final UnresolvedMosaicIdDto mosaicId, final MosaicSupplyChangeActionDto action, final AmountDto delta) {
     ...
     */
    public static EmbeddedMosaicSupplyChangeTransactionBuilder create(final KeyDto signerPublicKey, final short version, final EntityTypeDto type, final UnresolvedMosaicIdDto mosaicId, final MosaicSupplyChangeActionDto action, final AmountDto delta) {
        return new EmbeddedMosaicSupplyChangeTransactionBuilder(signerPublicKey, version, type, mosaicId, action, delta);
    }
