...
public final class EmbeddedMosaicMetadataTransactionBuilder extends EmbeddedTransactionBuilder {
     ...
     */
    protected EmbeddedMosaicMetadataTransactionBuilder(final KeyDto signerPublicKey, final short version, final EntityTypeDto type, final KeyDto targetPublicKey, final long scopedMetadataKey, final UnresolvedMosaicIdDto targetMosaicId, final short valueSizeDelta, final ByteBuffer value) {
     ...
     */
    public static EmbeddedMosaicMetadataTransactionBuilder create(final KeyDto signerPublicKey, final short version, final EntityTypeDto type, final KeyDto targetPublicKey, final long scopedMetadataKey, final UnresolvedMosaicIdDto targetMosaicId, final short valueSizeDelta, final ByteBuffer value) {
        return new EmbeddedMosaicMetadataTransactionBuilder(signerPublicKey, version, type, targetPublicKey, scopedMetadataKey, targetMosaicId, valueSizeDelta, value);
    }
