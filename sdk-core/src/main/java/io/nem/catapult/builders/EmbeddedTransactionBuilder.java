...
public class EmbeddedTransactionBuilder {
     ...
     */
    protected EmbeddedTransactionBuilder(final KeyDto signerPublicKey, final short version, final EntityTypeDto type) {
     ...
     */
    public static EmbeddedTransactionBuilder create(final KeyDto signerPublicKey, final short version, final EntityTypeDto type) {
