...
public final class AccountOperationRestrictionTransactionBuilder extends TransactionBuilder {
     ...
     */
    protected AccountOperationRestrictionTransactionBuilder(final SignatureDto signature, final KeyDto signerPublicKey, final short version, final EntityTypeDto type, final AmountDto fee, final TimestampDto deadline, final AccountRestrictionTypeDto restrictionType, final ArrayList<AccountOperationRestrictionModificationBuilder> modifications) {
     ...
     */
    public static AccountOperationRestrictionTransactionBuilder create(final SignatureDto signature, final KeyDto signerPublicKey, final short version, final EntityTypeDto type, final AmountDto fee, final TimestampDto deadline, final AccountRestrictionTypeDto restrictionType, final ArrayList<AccountOperationRestrictionModificationBuilder> modifications) {
        return new AccountOperationRestrictionTransactionBuilder(signature, signerPublicKey, version, type, fee, deadline, restrictionType, modifications);
    }
