...
public final class EmbeddedMosaicAliasTransactionBuilder extends EmbeddedTransactionBuilder {
     ...
     */
    protected EmbeddedMosaicAliasTransactionBuilder(final KeyDto signerPublicKey, final short version, final EntityTypeDto type, final AliasActionDto aliasAction, final NamespaceIdDto namespaceId, final MosaicIdDto mosaicId) {
     ...
     */
    public static EmbeddedMosaicAliasTransactionBuilder create(final KeyDto signerPublicKey, final short version, final EntityTypeDto type, final AliasActionDto aliasAction, final NamespaceIdDto namespaceId, final MosaicIdDto mosaicId) {
        return new EmbeddedMosaicAliasTransactionBuilder(signerPublicKey, version, type, aliasAction, namespaceId, mosaicId);
    }
